            ...
            [
                [
                    InlineKeyboardButton(
                        "️ المطـور ️", url="https://t.me/UUssUU")
                  ],[
                    InlineKeyboardButton(
                        " قـناة البوت ", url="https://t.me/nnnnBn"
                    ),
                ],[ 
                    InlineKeyboardButton(
                        "➕  اضفني الى مجموعتك ➕", url="https://t.me/nnnnBn"
                    )]
            ]
        ),
...
- /skip لتخطي الاغنيه الحاليه والانتقال الى الاغنيه التاليه**""",
      reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        " قنـاة الدعـم", url="https://t.me/nnnnBn")
                ],[
                    InlineKeyboardButton(
                        " المطور", url="https://t.me/UUssUU"
                    )
                ]
            ]
        )
